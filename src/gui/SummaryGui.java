...
public class SummaryGui extends JFrame implements ActionListener {
	...
	private JButton update, randomise, quit;
	...
	public SummaryGui(SummaryAgent summary) {
		...
		update.setToolTipText("Update operation");
		update.addActionListener(this);
		pane.add(randomise = new JButton("Randomise"));
		randomise.setToolTipText("Random operation");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		} else if (ae.getSource() == randomise) {
			alertInfo("Randomise values");
			GuiEvent ge = new GuiEvent(this, RANDOMISE_SIGNAL);
			myAgent.postGuiEvent(ge);
		}
	}
